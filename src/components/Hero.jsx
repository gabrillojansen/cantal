...
export const Hero = () => {
  return (
    <div className="max-w-[1200px] m-auto h-[100vh] px-4 flex items-center justify-between">
        <div>
            <h1 className="text-[50px] leading-[4rem] font-bold">THE EASY WAY TO <br/> TAKEOVER A LEASE</h1>
            <p className="mt-[1rem] text-[14px]">Live in Philippines, Rent a car now!</p>
            <div className="absolute flex gap-4 bg-[#FDFEFE] px-4 py-2 shadow-xl rounded-2xl  mt-[2rem]">
                <input
                type="text" name="inp1"
                ...
                <button className="text-[13px] bg-[--header-btn-bg] text-[--header-btn-text] py-2 px-4 rounded transition-[.3s] hover:bg-[--header-item-hover]">Search</button>
            </div>
        </div>
        <div>
